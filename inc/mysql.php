...
class DataBase extends MySQLi{
    ...
    public function log_db_errors($error, $query)
    {
       ...
       /* $headers  = 'MIME-Version: 1.0' . "\r\n";
        ...
        $headers .= 'To: jcaballero84@gmail.com' . "\r\n";
        $headers .= 'From: Soporte <soporte@freelancer.com.py>' . "\r\n";

        $message = '<p>Error el '. date('Y-m-d H:i:s').':</p>';
        $message .= '<p>Query: '. htmlentities( $query ).'<br />';
        $message .= 'Error: ' . $error;
        $message .= '</p>';

        mail( 'jcaballero84@gmail.com', 'Error en BD JDM', $message, $headers);*/
