        ...
        case 'ver':
            ...
            if (isset($_REQUEST['search']) && !empty($_REQUEST['search'])){
                ...
                $where = " AND CONCAT_WS(' ', lp.razon_social, lp.ruc, lp.direccion, lp.zona, lp.fecha_tope, c.razon_social, lp.estado, lp.pin, lp.correo, fecha_entrega) LIKE '%$search%'";
						...
						if ($id_clientex!='null') {
							$db->setQuery("SELECT SQL_CALC_FOUND_ROWS lp.id, lp.razon_social, lp.ruc, lp.observaciones, lp.consideraciones, d.direccion, d.id_direccion, z.zona, z.id_zona,
							...
							lp.id_lote AS nro_lote, lp.cantidad_reprogramaciones, lp.entidad, fecha_entrega, lp.hora_confirmacion, lp.observaciones
							...
							WHERE 1=1 AND lp.estado='NO ENTREGADO'
